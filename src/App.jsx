...
function PlanPage({t,planKpi,monthPlanData,asinPlanBkData,seller,store,asinF}){
  ...
  return<div>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:12,marginBottom:16}}><PlanKpi title="Sessions" actual={kpiData.se.a} plan={kpiData.se.p} t={t}/><PlanKpi title="Impressions" actual={kpiData.im.a} plan={kpiData.im.p} t={t}/><PlanKpi title="Conv. Rate" actual={kpiData.cr.a!=null?(Math.round(kpiData.cr.a*10000)/100)+"%":null} plan={(Math.round(kpiData.cr.p*10000)/100)+"%"} t={t}/><PlanKpi title="CTR" actual={kpiData.ct.a!=null?(Math.round(kpiData.ct.a*10000)/100)+"%":null} plan={(Math.round(kpiData.ct.p*10000)/100)+"%"} t={t}/></div>
